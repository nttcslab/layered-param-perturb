...
def read_dir():
    dir = 'main-bp_know_def'
    alldf = pd.DataFrame()
    lastdf = pd.DataFrame()
    vectors = ['fromI', ]
    cuda_ids = [1, 2, 3, 4, 5, 6]
    dataset_list = ['MNIST', 'MNIST', 'MNIST', 'FMNIST', 'FMNIST', 'FMNIST']
    numf_list = [16, 32, 64, 16, 32, 64]
    numl_list = [[16], [32], [64,], [16], [32], [64,]]
    numz_list = [[16], [32], [64], [16], [32], [64]]
